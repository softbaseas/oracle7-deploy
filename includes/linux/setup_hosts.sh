...
# Remove all lines including 'changefmw': sed "s/\S*\(sbsv12master\)\S*//g" /etc/hosts
...
sed -e "/sbsv12l6master/c sbsv12l6master.softbase.dk\tsbsv12master\t$externalIP\t$fqdn\t$subdomain" /etc/hosts > ./new_hosts.txt
